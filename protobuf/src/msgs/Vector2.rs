...
//! Generated file from `foxglove/Vector2.proto`
...
// @@protoc_insertion_point(message:foxglove.Vector2)
pub struct Vector2 {
    // message fields
    // @@protoc_insertion_point(field:foxglove.Vector2.x)
    pub x: f64,
    // @@protoc_insertion_point(field:foxglove.Vector2.y)
    pub y: f64,
    // special fields
    // @@protoc_insertion_point(special_field:foxglove.Vector2.special_fields)
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x16foxglove/Vector2.proto\x12\x08foxglove\"%\n\x07Vector2\x12\x0c\n\
