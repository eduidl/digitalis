...
impl ::protobuf::Message for LaserScan {
    ...
    fn compute_size(&self) -> u64 {
        ...
        my_size += ::protobuf::rt::vec_packed_double_size(6, &self.ranges);
        my_size += ::protobuf::rt::vec_packed_double_size(7, &self.intensities);
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        os.write_repeated_packed_double(6, &self.ranges)?;
        os.write_repeated_packed_double(7, &self.intensities)?;
