...
impl ::protobuf::Message for LocationFix {
    ...
    fn compute_size(&self) -> u64 {
        ...
        my_size += ::protobuf::rt::vec_packed_double_size(4, &self.position_covariance);
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        os.write_repeated_packed_double(4, &self.position_covariance)?;
        if self.position_covariance_type != ::protobuf::EnumOrUnknown::new(location_fix::PositionCovarianceType::UNKNOWN) {
...
pub mod location_fix {
    ...
    impl ::protobuf::Enum for PositionCovarianceType {
        ...
        fn from_str(str: &str) -> ::std::option::Option<PositionCovarianceType> {
            match str {
                "UNKNOWN" => ::std::option::Option::Some(PositionCovarianceType::UNKNOWN),
                "APPROXIMATED" => ::std::option::Option::Some(PositionCovarianceType::APPROXIMATED),
                "DIAGONAL_KNOWN" => ::std::option::Option::Some(PositionCovarianceType::DIAGONAL_KNOWN),
                "KNOWN" => ::std::option::Option::Some(PositionCovarianceType::KNOWN),
                _ => ::std::option::Option::None
            }
        }
